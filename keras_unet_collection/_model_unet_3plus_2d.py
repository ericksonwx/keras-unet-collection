...
def unet_3plus_2d_base(input_tensor, filter_num_down, filter_num_skip, filter_num_aggregate, kernel_size=3, dropout=None, spatial_dropout=None, rotation=None,
...
def unet_3plus_2d(input_size, filter_num_down, n_labels, kernel_size=3, dropout=None, spatial_dropout=None, rotation=None, filter_num_skip='auto', filter_num_aggregate='auto', 
    ...
    * Upsampling is achieved through bilinear interpolation and can be replaced by transpose convolutional layers here.
    ...
    X_decoder = unet_3plus_2d_base(IN, filter_num_down, filter_num_skip, filter_num_aggregate, kernel_size=kernel_size,
                                   dropout=dropout, spatial_dropout=spatial_dropout, rotation=rotation,
