...
def unet_3plus_2d_base(input_tensor, filter_num_down, filter_num_skip, filter_num_aggregate, kernel_size=3, dropout=None, spatial_dropout=None,
                       l1=1e-2, l2=1e-2, stack_num_down=2, stack_num_up=1, activation='ReLU', batch_norm=False, pool=True, unpool=True, 
    ...
    * Upsampling is achieved through bilinear interpolation and can be replaced by transpose convolutional layers here.
    ...
    if backbone is None:
        ...
        X = CONV_stack(X, filter_num_down[0], kernel_size=kernel_size, dropout=dropout, spatial_dropout=spatial_dropout, stack_num=stack_num_down, l1=l1, l2=l2,
...
def unet_3plus_2d(input_size, filter_num_down, n_labels, kernel_size=3, dropout=None, spatial_dropout=None, filter_num_skip='auto', filter_num_aggregate='auto', 
    ...
    * Upsampling is achieved through bilinear interpolation and can be replaced by transpose convolutional layers here.
    ...
    X_decoder = unet_3plus_2d_base(IN, filter_num_down, filter_num_skip, filter_num_aggregate, kernel_size=kernel_size,
                                   dropout=dropout, spatial_dropout=spatial_dropout, stack_num_down=stack_num_down, stack_num_up=stack_num_up, activation=activation, 
